...
use Kyqo\Console\Commands\MakeEventCommand;
use Kyqo\Console\Commands\MakeFactoryCommand;
...
use Kyqo\Console\Commands\MakeListenerCommand;
...
use Kyqo\Console\Commands\ScheduleRunCommand;
...
class Kernel
{
    ...
    /**
     * Override in app/Console/Kernel.php to register scheduled tasks.
     */
